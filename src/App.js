...
// Path Question Symbols
import UpStairsSymbol from './components/UpStairsSymbol';
import HallwaySymbol from './components/HallwaySymbol';
import DownStairsSymbol from './components/DownStairsSymbol';
    ...
    return (
      <div className="min-h-screen bg-gray-900 text-gray-200 p-4 flex items-center justify-center">
        <div className="text-center">
          ...
          <button onClick={generateIntuitiveQuestions}
...
className="w-full p-4 bg-gray-700 hover:bg-purple-900/50 hover:scale-105 hover:border-purple-500 active:scale-95 active:bg-purple-800 active:border-purple-400 border-2 border-gray-600 rounded-lg text-left transition-all group"
>
...
return (
    <div className="screen-fade min-h-screen bg-gray-900 text-gray-200 p-4">  
      <div className="max-w-md mx-auto bg-gray-800 rounded-lg p-6 border-2 border-gray-600">
        <h2 className="text-center bg-gray-700 text-gray-200 p-3 rounded mb-6 text-lg font-bold">
  ...
  <div className="space-y-4">
    ...
    <div className="grid grid-cols-2 gap-4">
      {currentQuestion.options.slice(0, 2).map(option => (
        <button
          ...
          className="p-4 bg-transparent border-none flex flex-col items-center justify-center text-white font-medium transition-all hover:scale-110"
        >
          <div className="w-24 h-24 flex items-center justify-center mb-1">
            {option.id === 'upstairs' && <UpStairsSymbol />}
            {option.id === 'hallway' && <HallwaySymbol />}
          </div>
    ...
    <div className="flex justify-center">
      {currentQuestion.options.slice(2, 3).map(option => (
        ...
        >
          <div className="w-24 h-24 flex items-center justify-center mb-1">
            {option.id === 'downstairs' && <DownStairsSymbol />}
          </div>
          <span className="text-lg">{option.text}</span>
        </button>
      ))}
